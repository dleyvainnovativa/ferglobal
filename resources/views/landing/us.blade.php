        ...
        <div class="py-5 text-start">
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <p class="lead">Somos una empresa autotransporte de carga terrestre que tuvo inicios hace más de 60 años, nos pusieron en los primeros lugares en crecimiento dentro de la industria del autotransporte.</p>
                    <p class="lead">Al pasar de los años fuimos creando alianzas comerciales a nivel nacional y actualmente ofrecemos servicios de logística terrestre en los principales puertos de la república mexicana, como por ejemplo, Veracruz, Altamira, Manzanillo y Lazaro Cardenas, no dejamos de lado los tránsitos internos dentro de México así como traslados terrestres desde y hacia norte, centro y Sudamérica.</p>
                    @php
